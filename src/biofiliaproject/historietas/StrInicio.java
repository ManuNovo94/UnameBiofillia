 ...
 * @author 47448880
 */
public class StrInicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("¿QUÉ TE PARECEN LAS HISTORIAS?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            StrPantalla1 strpant1 = new StrPantalla1();
            strpant1.setVisible(true);
            
            String nombre = nombreAlumno.getText();
            String curso = cursoAlumno.getText();
            
            strpant1.nombreAlumno.setText(nombre);
            strpant1.cursoAlumno.setText(curso);
            dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StrInicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
