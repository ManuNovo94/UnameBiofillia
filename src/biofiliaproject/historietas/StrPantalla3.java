 ...
 * @author 47448880
 */
public class StrPantalla3 extends javax.swing.JFrame {

    final int ID_HISTORIA=3;
    /**
    ...
    private void initComponents() {
        ...
        em_imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/biofiliaproject/rsc/story/historia3.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(panel_emPantalla1, javax.swing.GroupLayout.DEFAULT_SIZE, 1262, Short.MAX_VALUE)
        );
    ...
    private void btn_siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_siguienteActionPerformed
        ...
        StrPantalla4 strpant4 = new StrPantalla4();
        strpant4.setVisible(true);
            
        String nombre = nombreAlumno.getText();
        String curso = cursoAlumno.getText();
            
        strpant4.nombreAlumno.setText(nombre);
        strpant4.cursoAlumno.setText(curso);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StrPantalla3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StrPantalla3().setVisible(true);
            }
        });
    }
