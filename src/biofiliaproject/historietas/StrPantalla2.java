 ...
 */
package biofiliaproject.historietas;
 ...
 * @author 47448880
 */
public class StrPantalla2 extends javax.swing.JFrame {

    final int ID_HISTORIA=2;
    /**
    ...
    private void initComponents() {
        ...
        em_imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/biofiliaproject/rsc/story/historia2.png"))); // NOI18N
        ...
        panel_emPantalla1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_emPantalla1Layout.createSequentialGroup()
                ...
                .addGroup(panel_emPantalla1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panel_emPantalla1Layout.createSequentialGroup()
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(panel_emPantalla1, javax.swing.GroupLayout.DEFAULT_SIZE, 1146, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(panel_emPantalla1, javax.swing.GroupLayout.PREFERRED_SIZE, 824, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_siguienteActionPerformed
        ...
        StrPantalla3 strpant3 = new StrPantalla3();
        strpant3.setVisible(true);
            
        String nombre = nombreAlumno.getText();
        String curso = cursoAlumno.getText();
            
        strpant3.nombreAlumno.setText(nombre);
        strpant3.cursoAlumno.setText(curso);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StrPantalla2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StrPantalla2().setVisible(true);
            }
        });
    }
    ...
    public void SaveAlegria(int id_alumno){
       ...
       try {
            ...
            String sql = "insert into historietas (id_historieta, id_alumno, id_emoticono) values ('"+ID_HISTORIA+"','"+id_alumno+"','"+ID_EMOTICONO+"')";
