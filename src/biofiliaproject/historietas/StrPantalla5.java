...
import biofiliaproject.preguntas.Vacio;
 ...
 * @author 47448880
 */
public class StrPantalla5 extends javax.swing.JFrame {

    final int ID_HISTORIA=5;
    /**
    ...
    private void initComponents() {
        ...
        em_imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/biofiliaproject/rsc/story/historia5.png"))); // NOI18N
    ...
    private void btn_siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_siguienteActionPerformed
        ...
        vacio.nombreAlumno.setText(nombre);
        vacio.cursoAlumno.setText(curso);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StrPantalla5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StrPantalla5().setVisible(true);
            }
        });
    }
