 ...
 * @author 47448880
 */
public class ImInicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("¿QUÉ TE PARECEN LAS IMÁGENES?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ImPantalla1 impant1 = new ImPantalla1();
            impant1.setVisible(true);
            
            String nombre = nombreAlumno.getText();
            String curso = cursoAlumno.getText();
            
            impant1.nombreAlumno.setText(nombre);
            impant1.cursoAlumno.setText(curso);
            dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ImInicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
