 ...
 * @author 47448880
 */
public class ImPantalla4 extends javax.swing.JFrame {

    final int ID_IMAGEN=4;
    /**
    ...
    private void initComponents() {
        ...
        em_imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/biofiliaproject/rsc/img/Miedo_Imagen4.png"))); // NOI18N
    ...
    private void btn_siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_siguienteActionPerformed
        ...
        ImPantalla5 impant5 = new ImPantalla5();
        impant5.setVisible(true);
            
        String nombre = nombreAlumno.getText();
        String curso = cursoAlumno.getText();
            
        impant5.nombreAlumno.setText(nombre);
        impant5.cursoAlumno.setText(curso);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ImPantalla4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ImPantalla4().setVisible(true);
            }
        });
    }
