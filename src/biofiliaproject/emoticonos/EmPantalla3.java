 ...
 * @author 47448880
 */
public class EmPantalla3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        em_imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/biofiliaproject/rsc/icon/relax3.png"))); // NOI18N
    ...
    private void btn_siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_siguienteActionPerformed
        ...
        EmPantalla4 empant4 = new EmPantalla4();
        empant4.setVisible(true);

        String nombre = nombreAlumno.getText();
        String curso = cursoAlumno.getText();

        empant4.nombreAlumno.setText(nombre);
        empant4.cursoAlumno.setText(curso);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmPantalla3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmPantalla3().setVisible(true);
            }
        });
    }
