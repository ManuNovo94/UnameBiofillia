 ...
 * @author 47448880
 */
public class EmPantalla2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        em_imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/biofiliaproject/rsc/icon/crying2.png"))); // NOI18N
    ...
    private void btn_siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_siguienteActionPerformed
        ...
        EmPantalla3 empant3 = new EmPantalla3();
        empant3.setVisible(true);

        String nombre = nombreAlumno.getText();
        String curso = cursoAlumno.getText();

        empant3.nombreAlumno.setText(nombre);
        empant3.cursoAlumno.setText(curso);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmPantalla2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmPantalla2().setVisible(true);
            }
        });
    }
