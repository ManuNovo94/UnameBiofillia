 ...
 * @author 47448880
 */
public class EmPantalla5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        em_imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/biofiliaproject/rsc/icon/vomiting5.png"))); // NOI18N
    ...
    private void btn_siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_siguienteActionPerformed
        ...
        EmPantalla6 empant6 = new EmPantalla6();
        empant6.setVisible(true);

        String nombre = nombreAlumno.getText();
        String curso = cursoAlumno.getText();

        empant6.nombreAlumno.setText(nombre);
        empant6.cursoAlumno.setText(curso);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmPantalla5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmPantalla5().setVisible(true);
            }
        });
    }
