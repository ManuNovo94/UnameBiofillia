 ...
 * @author 47448880
 */
public class EmPantalla1 extends javax.swing.JFrame {
    ...
    private void btn_siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_siguienteActionPerformed
        ...
        EmPantalla2 empant2 = new EmPantalla2();
        empant2.setVisible(true);

        String nombre = nombreAlumno.getText();
        String curso = cursoAlumno.getText();

        empant2.nombreAlumno.setText(nombre);
        empant2.cursoAlumno.setText(curso);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmPantalla1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmPantalla1().setVisible(true);
            }
        });
    }
