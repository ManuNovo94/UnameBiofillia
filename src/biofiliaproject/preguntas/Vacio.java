...
import biofiliaproject.contenedores.ConInicio;
...
public class Vacio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Y AHORA... UN DESCANSO");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ConInicio coninicio = new ConInicio();
        coninicio.setVisible(true);
        
        String nombre = nombreAlumno.getText();
        String curso = cursoAlumno.getText();
            
        coninicio.nombreAlumno.setText(nombre);
        coninicio.cursoAlumno.setText(curso);
        dispose();
