 ...
 * @author 47448880
 */
public class ConPantalla3 extends javax.swing.JFrame {

    final int ID_CONTENEDOR=3;
    /**
    ...
    private void initComponents() {
        ...
        em_imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/biofiliaproject/rsc/containers/contenedor_plastico.png"))); // NOI18N
    ...
    private void btn_siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_siguienteActionPerformed
        ...
        ConPantalla4 conpant4 = new ConPantalla4();
        conpant4.setVisible(true);
            
            String nombre = nombreAlumno.getText();
            String curso = cursoAlumno.getText();
            
            conpant4.nombreAlumno.setText(nombre);
            conpant4.cursoAlumno.setText(curso);
            dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConPantalla3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConPantalla3().setVisible(true);
            }
        });
    }
