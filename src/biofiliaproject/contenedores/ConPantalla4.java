 ...
 * @author 47448880
 */
public class ConPantalla4 extends javax.swing.JFrame {

    final int ID_CONTENEDOR=4;
    /**
    ...
    private void initComponents() {
        ...
        em_imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/biofiliaproject/rsc/containers/contenedor_organico.png"))); // NOI18N
    ...
    private void btn_siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_siguienteActionPerformed
        ...
        ConPantalla5 conpant5 = new ConPantalla5();
        conpant5.setVisible(true);
            
            String nombre = nombreAlumno.getText();
            String curso = cursoAlumno.getText();
            
            conpant5.nombreAlumno.setText(nombre);
            conpant5.cursoAlumno.setText(curso);
            dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConPantalla4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConPantalla4().setVisible(true);
            }
        });
    }
