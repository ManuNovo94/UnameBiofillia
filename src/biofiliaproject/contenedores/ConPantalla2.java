 ...
 * @author 47448880
 */
public class ConPantalla2 extends javax.swing.JFrame {

    final int ID_CONTENEDOR=2;
    /**
    ...
    private void initComponents() {
        ...
        em_imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/biofiliaproject/rsc/containers/contenedor_papel.png"))); // NOI18N
    ...
    private void btn_siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_siguienteActionPerformed
        ...
        ConPantalla3 conpant3 = new ConPantalla3();
        conpant3.setVisible(true);
            
            String nombre = nombreAlumno.getText();
            String curso = cursoAlumno.getText();
            
            conpant3.nombreAlumno.setText(nombre);
            conpant3.cursoAlumno.setText(curso);
            dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConPantalla2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConPantalla2().setVisible(true);
            }
        });
    }
