 ...
 * @author 47448880
 */
public class ConPantalla1 extends javax.swing.JFrame {

    final int ID_CONTENEDOR=1;
    /**
    ...
    private void initComponents() {
        ...
        em_imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/biofiliaproject/rsc/containers/contenedor_vidrio.png"))); // NOI18N
    ...
    private void btn_siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_siguienteActionPerformed
        ...
        ConPantalla2 conpant2 = new ConPantalla2();
        conpant2.setVisible(true);
            
            String nombre = nombreAlumno.getText();
            String curso = cursoAlumno.getText();
            
            conpant2.nombreAlumno.setText(nombre);
            conpant2.cursoAlumno.setText(curso);
            dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConPantalla1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConPantalla1().setVisible(true);
            }
        });
    }
